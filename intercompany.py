...
count = 0
while count <= 261:
    url = f'https://manufacturers.ru/foreign-companies?page={count}'
    headers = {
    ...
    for i in heads:
        ...
        fields = ['name', 'categ_1', 'categ_2', 'categ_3', 'param_1', 'param_2', 'param_3', 'param_4', 'param_5',
                  'cont_1', 'cont_2', 'cont_3', 'cont_4']
        with open('intercommerce.csv', 'a+', encoding='utf-16') as file:
